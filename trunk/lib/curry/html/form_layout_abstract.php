...
abstract class FormLayoutAbstract extends HtmlElement
{
	...
	protected function _createCaptionContainer(FormElement $formElement)
	{
		...
		// set class attribute of container element
		if ($formElement->getCaptionContainerClass() != null) {
			$containerElement->addClass($this->$formElement->getCaptionContainerClass());
		} else if ($this->_captionContainerClass) {
	...
	protected function _createInputContainer(FormElement $formElement)
	{
		...
		// set class attribute of container element
		if ($formElement->getInputContainerClass() != null) {
			$containerElement->addClass($this->$formElement->getInputContainerClass());
		} else if ($this->_inputContainerClass) {
