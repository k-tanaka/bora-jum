...
class Model extends CurryClass
{
	 ...
	 *
	 * @return string Alias ​​for the table that is currently set
	 */
	 ...
	 *
	 * @return string Table name to associate with class that is currently set
	 */
	 ...
	 * @return array $rows Rows information
	 */	
	 ...
	 * @param string  $name Field names that combined by "And"
	 * @param array  $args Values for fields
	 * @return array $row Row information
	 */	
